...
export default function Page() {
  ...
  const pageTitle = "Paiement - Spa & Prestige Collection";
  const pageDescription = "Finalisez votre commande en toute sécurité sur Spa & Prestige Collection. Paiement rapide et sécurisé pour vos soins et produits bien-être.";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="paiement spa, checkout spa, spa prestige, paiement sécurisé, commande spa" />
