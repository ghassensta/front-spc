  ...
  const data = [
    {
      ...
      description: '1 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua mundis estabien estrama lorium ispolium.',
      image:
    ...
    },
    {
      ...
      description: '2 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua mundis estabien estrama lorium ispolium.',
      image:
        "https://spa-prestige-collection.com/wp-content/uploads/2025/03/SPC-Essence-1975x1318-02.jpg",
    },
    {
      ...
      description: '3 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua mundis estabien estrama lorium ispolium.',
      image:
        "https://spa-prestige-collection.com/wp-content/uploads/2025/03/SPC-Essence-1975x1318-02.jpg",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-24">
          ...
          <div className="w-full md:w-1/3">
           <div className="flex gap-3 my-4">
            ...
            <h3 className="text-[#B6B499] text-3xl mt-4">{data[currentIndex].title}</h3>
            <p className="font-tahoma text-sm ">{data[currentIndex].description}</p>
          </div>
        </div>
      </div>
    </div>
